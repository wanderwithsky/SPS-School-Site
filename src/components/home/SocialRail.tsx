...
function GmailIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true" focusable="false">
      <path
        fill="#4285F4"
        d="M22.5 5.5v13a1.5 1.5 0 0 1-1.5 1.5h-2.4V9.2L12 13.9 7.4 20.0H3a1.5 1.5 0 0 1-1.5-1.5v-13z"
      />
      <path fill="#34A853" d="M1.5 18.5v-9.3l4.9 3.6V20H3a1.5 1.5 0 0 1-1.5-1.5" />
      <path
        fill="#FBBC04"
        d="M1.5 5.5A1.9 1.9 0 0 1 4.5 4.1L12 9.6l7.5-5.5a1.9 1.9 0 0 1 3 1.4L12 13.6z"
      />
